<form method="post" class="ajax-screen-submit" autocomplete="off" action="{{ route('companies.store') }}" enctype="multipart/form-data">
	...
	<div class="row p-2">
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="company_code" value="{{ $company_code }}" required readonly>
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="company_phone" value="{{ old('company_phone') }}" required>
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="company_email" value="{{ old('company_email') }}" required>
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="contact_info" value="{{ old('contact_info') }}" required>
