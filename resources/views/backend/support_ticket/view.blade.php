		...
		<div class="card">
		    <div class="card-header d-flex align-items-center">
				...
				@if($supportticket->status == 1 && has_permission('support_tickets.mark_as_closed'))
					<a href="{{ route('support_tickets.mark_as_closed', $supportticket->id) }}" class="btn btn-outline-success ml-auto"><i class="fa-solid fa-circle-check"></i> {{ _lang('Mark as Closed') }}</a>
				@endif
			</div>
