<table class="table table-bordered">
	...
	<tr><td>{{ _lang('Created By') }}</td><td>{{ $transaction->created_by->name ? $transaction->created_by->name : $transaction->created_by->first_name.' '.$transaction->created_by->last_name}}</td></tr>
</table>
