...
<div class="row">
  <div class="col-lg-6 offset-lg-3">
    <div class="card">
      ...
      <div class="card-body">
        <form method="post" class="validate" enctype="multipart/form-data" autocomplete="off" action="{{ route('loans.loan_payment', $loan->id) }}">
          {{ csrf_field() }}
          <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label class="control-label">{{ _lang('Upload Proof Of Payment') }}</label>
                <input type="file" name="recipet" class="form-control">
              </div>
            </div>
            ...
            <div class="col-md-12">
             <div class="form-group">
              <button type="submit" class="btn btn-primary btn-lg btn-block"><i class="fa-solid fa-circle-check"></i> {{ _lang('Make Payment') }}</button>
            </div>
          </div>
        </div>
      </form>
